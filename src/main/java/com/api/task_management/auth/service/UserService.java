...
//        user.setCreated_at(new Date());
    ...
    public ResponseEntity<Map<String, Object>> login(LoginModel user) {
        ...
        String token = jWTService.generateToken(userModel.getUsername(), String.valueOf(userModel.getUid()));
        int userId = userModel.getUid();
